...
3. Profile Image Found on `index.html`:
   ...
   * If you don't have a picture, you can grab a placeholder image from [LoremPicsum](https://picsum.photos/). Save the images to your `images` folder.

4. Portfolio Images:
   * Placeholder images can be found at [LoremPicsum](https://picsum.photos/). 
...
6. Dimensions:
   ...
   * Pro-tip: Use the [Page Ruler](https://chrome.google.com/webstore/detail/page-ruler/jcbmcnpepaddcedmjdcmhbekjhbfnlff?hl=en) extension to measure the size of elements.

   ![Recommended Dimensions](Images/Recommended-Dimensions.png)

### Bonus

1. Make your pages more sophisticated by adding style to text links, to image links, and to buttons for when a user hovers their cursor over them. A CSS hover tutorial can be found [here](https://www.youtube.com/watch?v=bJ6oSs3xufQ). 
